...
class Qtcv(QMainWindow, qtcvui.Ui_MainWindow):
    def __init__(self):
        ...
        self.frame = None
        self.capture = None
        self.a_videoFileName = None
        self.a_isVideoFileLoaded = False
        self.b_videoFileName = None
        self.b_isVideoFileLoaded = False
    ...
    def load_file(self):
        try:
            ...
            self.a_videoFileName = QFileDialog.getOpenFileName(self, 'Select .h264 Video File')[0]
